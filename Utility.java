...
class Utility {
    ...
    public void updateUser(){
        ...
        try {
            ...
            Files.write(updated_users, Collections.singletonList(text), StandardOpenOption.WRITE);
        } catch (Exception e) {
            e.getStackTrace();
        }
        ...
        for(int i = 1; i < userDataArray.size(); i++){
            ...
            try {
                Files.write(updated_users, Collections.singletonList(userInfo), StandardOpenOption.APPEND);
            } catch (Exception e) {
                e.getStackTrace();
            }
        }
